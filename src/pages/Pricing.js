  ...
  return (
    <main className='container'>
      <section className='container'>
          <h1 className='text-center'>Choose the right plan for your business</h1>
          <p className='text-center text-muted'>Used by freelancers, startups, companies and enterprise-level corporations all over the world</p>
      </section>
      <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
          <a href="/" class="d-flex align-items-center link-body-emphasis text-decoration-none">
            ...
            <span class="fs-4">Pricing Options</span>
          </a>
